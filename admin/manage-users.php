                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <form name="abc" action="" method="post">
                                                            ...
                                                            <a href="eliminar_usuario.php?id=<?php echo $row['id']; ?>" class="btn btn-danger btn-xs btn-mini rounded-0" onclick="return confirm('¿Estás seguro de que deseas eliminar este usuario?')">Eliminar</a>
                                                        </form>
                                                    </td>
                                                </tr>
                                            <?php $cnt = $cnt + 1;
