   ...
   <div class="page-sidebar-wrapper scrollbar-dynamic" id="main-menu-wrapper">
     <div class="user-info-wrapper">
       <div class="profile-wrapper" style="border:solid #fff 1px;">
         <img src="../assets/img/logo.jpeg" alt="" data-src="../assets/img/logo.jpeg" data-src-retina="../assets/img/logo.jpeg" class="side-user-img" />
       </div>
       <div class="user-info">
     ...
     <!-- END MINI-PROFILE -->
     <!-- BEGIN SIDEBAR MENU -->
     <p class="menu-title"> <span class="pull-right"><a href="#" onclick="location.reload()"><i class="fa fa-refresh"></i></a></span></p>
