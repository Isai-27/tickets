						...
						<div class="tiles-body">
							...
							<div class="widget-stats">
								<div class="wrapper transparent">
									...
									<span class="item-title">Todos</span> <span class="item-count animate-number semi-bold" data-value="<?php echo $rw; ?>" data- animation-duration="700">0</span>
								</div>
							</div>
							<div class="widget-stats ">
								<div class="wrapper last">
