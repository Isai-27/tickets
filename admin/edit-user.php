          ...
          <form name="muser" method="post" action="" enctype="multipart/form-data">
            <div class="row justify-content-center">
              <div class="col-lg-8 col-md-10 col-xs-12 mx-auto">
                ...
                <div class="form-group">
                  <label for="alt_email" class="control-label">Correo Alternativo</label>
                  <input type="email" class="form-control rounded-0" id="alt_email" name="alt_email" value="<?php echo $rw['alt_email']; ?>" required="required">
                </div>
                <div class="form-group">
                  <label for="mobile" class="control-label">Número de contacto</label>
                ...
                <div class="form-group">
                  ...
                  <select class="form-control rounded-0" id="gender" name="gender" required="required">
                    <option value="male" <?= $rw['gender'] == 'male' ? "selected" : "" ?>>Hombre</option>
                    <option value="female" <?= $rw['gender'] == 'female' ? "selected" : "" ?>>Mujer</option>
                  </select>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  <div class="text-center">
                    <button type="submit" name="update" class="btn btn-primary">Guardar ccambios</button>
                  </div>
                </div>
              </div>
            </div>
